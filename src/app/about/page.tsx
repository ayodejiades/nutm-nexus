...
export default function AboutPage() {
    const sectionStyle = "mb-10"; // Consistent spacing
    const headingStyle = "text-2xl font-semibold text-foreground dark:text-white border-l-4 border-primary pl-4 mb-4"; // Added padding
      ...
      <div className="space-y-10">
        ...
        <section className={sectionStyle}>
          ...
          <ul className="list-disc list-outside space-y-3 pl-5 text-base text-foreground/80 dark:text-foreground/70">
            <li>
              <strong>Frontend:</strong> Built with <a href="https://nextjs.org/" target="_blank" rel="noopener noreferrer" className={linkStyle}>Next.js</a> & <a href="https://react.dev/" target="_blank" rel="noopener noreferrer" className={linkStyle}>React</a>, styled using <a href="https://tailwindcss.com/" target="_blank" rel="noopener noreferrer" className={linkStyle}>Tailwind CSS</a> for a modern, responsive interface. Written in <a href="https://www.typescriptlang.org/" target="_blank" rel="noopener noreferrer" className={linkStyle}>TypeScript</a>.
            </li>
            <li>
              <strong>Data Storage:</strong> All course metadata and tutorial files are stored directly within a single <a href="https://github.com/" target="_blank" rel="noopener noreferrer" className={linkStyle}>GitHub</a> repository.
            </li>
            <li>
              <strong>Authentication:</strong> Secure login via GitHub OAuth using <a href="https://next-auth.js.org/" target="_blank" rel="noopener noreferrer" className={linkStyle}>NextAuth.js</a>.
            </li>
            <li>
              <strong>Hosting:</strong> Deployed globally and hosted for free on <a href="https://vercel.com/" target="_blank" rel="noopener noreferrer" className={linkStyle}>Vercel</a>.
            </li>
          </ul>
        </section>
        ...
        <section className={sectionStyle}>
         ...
         <section className="text-center mt-12 pt-8 border-t border-gray-200 dark:border-gray-700">
             ...
             {/* Maybe add a link to the /team page */}
         </section>
