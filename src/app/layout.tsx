        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div>
            ...
            <p className="mt-6 text-xs text-foreground/40">
              © {new Date().getFullYear()} NUTM Nexus. Made by <Link href="https://ayodeji.tech" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Ayodeji Adesegun</Link>.
            </p>
          </div>
          <div>
